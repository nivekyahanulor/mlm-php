						...
						$underBy             = $getLevel2[0]->membercode_left;
						...
						<?php } else { ?>
							...
							<?php // <!-- LEVEL 4 LEFT-->//
											...
											$this->load->view('user/binary/right_leg/4th_level', array("getLevel4"=>$getLevel4));
							?>
							</li>
							<?php } ?>
							...
							<?php } else { ?>
								...
								<li>
									...
									<?php // <!-- LEVEL 4 LEFT-->//
											...
											$getLevel4    	    = $binarylevel4->result();
											$this->load->view('user/header');
											$this->load->view('user/binary/right_leg/4th_level_1', array("getLevel4"=>$getLevel4));
							?>
									</li>
							<?php } ?>
						</ul>
								  ...
								  <div class="modal-body">
									   ...
									   <div class="form-group">
										...
										<div class="input-group ">
											...
											?>
												<input type="hidden" value="5" class="form-control" name="cnt" required>
									   ...
									   <div class="form-group">
										...
										<div class="input-group ">
											...
											<?php } else { 
												if($Level ==3 && $position=='Left'){
											?>
												<input type="hidden" value="6" class="form-control" name="cnt" required>
											<?php } else if($Level ==3 && $position=='Right'){ ?>
												<input type="hidden" value="6" class="form-control" name="cnt" required>
											<?php } ?>
											<?php } ?>
