							<?php
							$sdata = $getProcess[0]->membercode_right;
							...
							<?php if($getProcess[0]->membercode_right==""){?>
							 <li>
								<a href="" data-toggle="modal" data-target="#adddataright">
                                ...
                                <a href="#">
                                    <div class="container-fluid <?php echo $pack;?>">
										<center><div style="height:2px;"></div>
											...
											<?php echo $getProcess[0]->membercode_right;?>
                                       </center>
                                    </div>
                                </a>
							<?php 
									// -- LEVEL 2 LEFT-- //
									$directcode   		= $getProcess[0]->membercode_right;
									...
									$this->load->view('user/binary/right_leg/2nd_level', array("getLevel2"=>$getLevel2));
							?>
                            </li>
							<?php }?>
