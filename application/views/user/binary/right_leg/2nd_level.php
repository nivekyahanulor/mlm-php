							...
							<?php 
								...
								$underBy            = $getProcess[0]->binary_code_right;
								$sponsorMemberCode  = $getProcess[0]->sponsorMemberCode;
							?>
								<?php if($getLevel2[0]->membercode_left==""){?>
									<li><a href="" style="height:70px !important;width:100px !important;" data-toggle="modal" data-target="#adddownlineleft<?php echo $modalID;?>"><div class="user available"> <i class="fa fa-user-circle fa-5x" aria-hidden="true"></i></div> </a></li>
								<?php } else { ?>
									<?php	
									...
									?>
								<li>
                                    <a href="#" style="height:70px !important;width:100px !important;">
									...
									<?php 		// <!-- LEVEL 3 LEFT--> //
												...
												$this->load->view('user/binary/right_leg/3rd_level', array("getLevel3"=>$getLevel3));
									?>
								<!-- END LEVEL 3-->
                                </li>
								<?php } ?>
								...
								<li>
									...
									<?php 		// <!-- LEVEL 3 LEFT--> //
												...
												$getLevel3    		 = $binarylevel3->result();
												$this->load->view('user/header');
												$this->load->view('user/binary/right_leg/3rd_level_1', array("getLevel3"=>$getLevel3));
									?>
								</li>
							<?php } ?>
