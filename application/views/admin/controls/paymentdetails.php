            ...
            <div class="card">
			   <div class="text-left logo p-2 px-5"> <img src="<?php echo base_url();?>/assets/img/logo.png" width="50">	
                ...
                <div class="invoice p-5">
                    <h5><?php if($product[0]->order_status==0){ echo 'PENDING ORDER';}?></h5> 
					<?php 
					$memberid   = $product[0]->memberID;
					...
					<?php if($product[0]->order_status==0){?>
					<span>Purchased Date : <?php echo  $product[0]->paydate;?></span>
					<?php } ?>
                        ...
                        <table class="table table-borderless">
                            <tbody>
                                <tr>
								 ...
								 <tr>
                                    <td>
                                        <div class="py-2"> <span class="d-block text-muted">Delivery Address</span> <span><?php echo $product[0]->deliveryaddress;?></span> </div>
                                    </td>
                                    <td>
                                        <div class="py-2"> <span class="d-block text-muted">Payment Transaction Code</span> <span><?php echo $product[0]->paytranscode;?></span> </div>
                                    </td>
                                    <td>
                                        <div class="py-2"> <span class="d-block text-muted">Payment By </span> <span><?php echo $product[0]->payname;?></span> </div>
                                    </td>
                                    <td>
                                        <div class="py-2"> <span class="d-block text-muted">Pay Amount</span> <span><?php echo  $product[0]->payamount;?></span> </div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
