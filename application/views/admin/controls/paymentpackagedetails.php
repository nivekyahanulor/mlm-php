					  ...
					  <div class="modal-dialog" role="document">
							  <div class="modal-content">
								...
								<div class="modal-body">
										<form id="conf-form"  method="post" action="<?php echo site_url('administrator/api/confirmpackagepayment');?>">
                ...
                <div class="invoice">
                    ...
                    <div class="row" style="text-align: right;">
						...
						<?php if($this->uri->segment(5) !='approved') {?>
                            ...
                            <button class="btn btn-warning btn-md" data-toggle="modal" data-target="#declinerders"><i class="fas fa-circle"></i> DECLINE PAYMENT </button>
                       <?php } else { ?>
