              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <li class="nav-item">
                        <a href="<?php echo site_url("administrator/payments");?>" class="nav-link " >PRODUCT</a>
                      </li>
                      <li class="nav-item">
                        <a href="<?php echo site_url("administrator/payments/package");?>" class="nav-link " >PACKAGE</a>
                      </li>
                     <li class="nav-item">
                        <a href="<?php echo site_url("administrator/payments/upgrades");?>" class="nav-link active" >UPGRADES</a>
                      </li>
                    
                    </ul><br><br>
                    <div class="table-responsive">
                      <table class="table table-striped table-bordered" id="payment-upgrade-data">
                        <thead>
                          <tr>
