              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <li class="nav-item">
                        <a href="<?php echo site_url("administrator/payments/package");?>" class="nav-link active" >PACKAGE</a>
                      </li>
                      <li class="nav-item">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-bordered" id="payment-package-data">
                        <thead>
                          <tr>
